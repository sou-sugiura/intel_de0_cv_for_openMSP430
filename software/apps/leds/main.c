...
int main(void) {
  ...
  WDTCTL = WDTPW | WDTSSEL | WDTCNTCL | WDTTMSEL;  // Select ACLK | Clear timer | Enable interval timer mode | div32768 //sugi for implement setting
//  WDTCTL = WDTPW | WDTCNTCL | WDTTMSEL | WDTIS0; //sugi for rtlsim setting
  IE1_set_wdtie();
